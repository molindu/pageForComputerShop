   ...
   <head>
     <title>Order-email</title>
      <link rel="stylesheet" type="text/css" href="style-main.css">
        ...
        <!-- <link rel="stylesheet" type="text/css" href="style-image-zooming.css"> -->
    	...
    	<!-- <script type="text/javascript" src="script-image-zooming.js"></script> -->
    	   ...
    	   <?php  
    	    if(isset($_POST['submit']))
    	     ...
    	     if(mail($to, $subject, $message)){
	            	echo "<p class="."success".">Your message was sent succesfully ".$name. ".<br>..  Thank you for using our services<br>
